-- Create the route analysis KPI mart.
--
-- Grain:
-- One row per pickup zone and dropoff zone route.
--
-- Source tables:
-- fact_trips, dim_zone

CREATE OR REPLACE TABLE `nyc-taxi-project-502819.nyc_taxi_ops.mart_route_analysis`
...
WITH route_metrics AS (
    ...
    INNER JOIN `nyc-taxi-project-502819.nyc_taxi_ops.dim_zone` AS pickup_zone
        ON f.pickup_location_id = pickup_zone.location_id
    INNER JOIN `nyc-taxi-project-502819.nyc_taxi_ops.dim_zone` AS dropoff_zone
